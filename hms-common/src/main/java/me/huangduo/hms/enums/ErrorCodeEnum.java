...
public enum ErrorCodeEnum {
    ...
    HOME_ERROR_209(2209, "用户名格式错误"),
    HOME_ERROR_210(2210, "该角色已存在"),
    HOME_ERROR_211(2211, "该家庭中无此角色"),
    HOME_ERROR_212(2212, "角色信息格式错误"),
    HOME_ERROR_213(2213, "该用户无权访问此家庭"),
    HOME_ERROR_214(2214, "权限信息格式错误"),
    HOME_ERROR_215(2215, "邀请码格式错误"),
    HOME_ERROR_216(2216, "邀请信息不存在"),
    HOME_ERROR_217(2217, "邀请已过期"),
    HOME_ERROR_218(2218, "家庭成员角色不存在"),
    HOME_ERROR_219(2219, "无操作权限, 请联系家庭管理员"),
    HOME_ERROR_220(2220, "无法更改自己的角色, 需要其他家庭管理员修改"),
